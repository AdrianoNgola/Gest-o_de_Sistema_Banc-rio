    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           //Instancia do objecto cliente
            Clientes Cliente1 = new Clientes(Convert.ToInt32(txtBI.Text), txtNome.Text, txtSobrenome.Text,Convert.ToDateTime(dateTimePicker1.Text),Convert.ToInt32(txtBI.Text), Sexo,Convert.ToInt32(txtNTelefone.Text), Convert.ToInt32(cbxMunicipio.SelectedValue));
