    ...
    public partial class Form2 : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand Comando_3 = new SqlCommand($"Select *from Contactos_Cliente", Conector);

                SqlDataAdapter Adpatador_3 = new SqlDataAdapter(Comando_3);
                DataTable Tabela_3 = new DataTable();
                Adpatador_3.Fill(Tabela_3);

                dataGridView3.DataSource = Tabela_3;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception Ex)
            {
                ...
                MessageBox.Show($"Precisa digitar o número de conta do cliente");
            }
        }
           ...
           // catch (Exception Ex)
            {
                ...
                MessageBox.Show($"Selecione o cliente que pretende eliminar");
            }
        }
